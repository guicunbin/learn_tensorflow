...
checkpoint_path="/home/gui/work2017/ckpt_data/inception_v4_ckpt/inception_v4.ckpt"
  ...
  with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
    ...
    with tf.variable_scope(scope, 'BlockInceptionA', [inputs], reuse=reuse):
      with tf.variable_scope('Branch_0'):
        branch_0 = slim.conv2d(inputs, 96, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_1'):
        branch_1 = slim.conv2d(inputs, 64, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_1 = slim.conv2d(branch_1, 96, [3, 3], scope='Conv2d_0b_3x3',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_2'):
        branch_2 = slim.conv2d(inputs, 64, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0b_3x3',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0c_3x3',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_3'):
        branch_3 = slim.avg_pool2d(inputs, [3, 3], scope='AvgPool_0a_3x3')
        branch_3 = slim.conv2d(branch_3, 96, [1, 1], scope='Conv2d_0b_1x1',normalizer_fn=slim.batch_norm)
...
def block_reduction_a(inputs, scope=None, reuse=None):
  ...
  with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
    ...
    with tf.variable_scope(scope, 'BlockReductionA', [inputs], reuse=reuse):
      ...
      with tf.variable_scope('Branch_1'):
        branch_1 = slim.conv2d(inputs, 192, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
...
def block_inception_b(inputs, scope=None, reuse=None):
  ...
  with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
    ...
    with tf.variable_scope(scope, 'BlockInceptionB', [inputs], reuse=reuse):
      with tf.variable_scope('Branch_0'):
        branch_0 = slim.conv2d(inputs, 384, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_1'):
        branch_1 = slim.conv2d(inputs, 192, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_1 = slim.conv2d(branch_1, 224, [1, 7], scope='Conv2d_0b_1x7',normalizer_fn=slim.batch_norm)
        branch_1 = slim.conv2d(branch_1, 256, [7, 1], scope='Conv2d_0c_7x1',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_2'):
        branch_2 = slim.conv2d(inputs, 192, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 192, [7, 1], scope='Conv2d_0b_7x1',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 224, [1, 7], scope='Conv2d_0c_1x7',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 224, [7, 1], scope='Conv2d_0d_7x1',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 256, [1, 7], scope='Conv2d_0e_1x7',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_3'):
        branch_3 = slim.avg_pool2d(inputs, [3, 3], scope='AvgPool_0a_3x3')
...
def block_reduction_b(inputs, scope=None, reuse=None):
  ...
  with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
    ...
    with tf.variable_scope(scope, 'BlockReductionB', [inputs], reuse=reuse):
      with tf.variable_scope('Branch_0'):
        branch_0 = slim.conv2d(inputs, 192, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_0 = slim.conv2d(branch_0, 192, [3, 3], stride=2,
                               padding='VALID', scope='Conv2d_1a_3x3',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_1'):
        branch_1 = slim.conv2d(inputs, 256, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_1 = slim.conv2d(branch_1, 256, [1, 7], scope='Conv2d_0b_1x7',normalizer_fn=slim.batch_norm)
        branch_1 = slim.conv2d(branch_1, 320, [7, 1], scope='Conv2d_0c_7x1',normalizer_fn=slim.batch_norm)
...
def block_inception_c(inputs, scope=None, reuse=None):
  ...
  with slim.arg_scope([slim.conv2d, slim.avg_pool2d, slim.max_pool2d],
    ...
    with tf.variable_scope(scope, 'BlockInceptionC', [inputs], reuse=reuse):
      with tf.variable_scope('Branch_0'):
        branch_0 = slim.conv2d(inputs, 256, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
      with tf.variable_scope('Branch_1'):
        branch_1 = slim.conv2d(inputs, 384, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_1 = tf.concat(axis=3, values=[
            slim.conv2d(branch_1, 256, [1, 3], scope='Conv2d_0b_1x3',normalizer_fn=slim.batch_norm),
            slim.conv2d(branch_1, 256, [3, 1], scope='Conv2d_0c_3x1',normalizer_fn=slim.batch_norm)])
      with tf.variable_scope('Branch_2'):
        branch_2 = slim.conv2d(inputs, 384, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 448, [3, 1], scope='Conv2d_0b_3x1',normalizer_fn=slim.batch_norm)
        branch_2 = slim.conv2d(branch_2, 512, [1, 3], scope='Conv2d_0c_1x3',normalizer_fn=slim.batch_norm)
        branch_2 = tf.concat(axis=3, values=[
            slim.conv2d(branch_2, 256, [1, 3], scope='Conv2d_0d_1x3',normalizer_fn=slim.batch_norm),
            slim.conv2d(branch_2, 256, [3, 1], scope='Conv2d_0e_3x1',normalizer_fn=slim.batch_norm)])
      with tf.variable_scope('Branch_3'):
        branch_3 = slim.avg_pool2d(inputs, [3, 3], scope='AvgPool_0a_3x3')
        branch_3 = slim.conv2d(branch_3, 256, [1, 1], scope='Conv2d_0b_1x1',normalizer_fn=slim.batch_norm)
      return tf.concat(axis=3, values=[branch_0, branch_1, branch_2, branch_3])
...
def inception_v4_base(inputs, final_endpoint='Mixed_7d', scope=None):
  ...
  with tf.variable_scope(scope, 'InceptionV4', [inputs]):
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
      ...
      # 147 x 147 x 32
      net = slim.conv2d(net, 64, [3, 3], scope='Conv2d_2b_3x3',normalizer_fn=slim.batch_norm)
      ...
      with tf.variable_scope('Mixed_3a'):
        ...
        with tf.variable_scope('Branch_1'):
          branch_1 = slim.conv2d(net, 96, [3, 3], stride=2, padding='VALID',
                                 scope='Conv2d_0a_3x3',normalizer_fn=slim.batch_norm)
      ...
      with tf.variable_scope('Mixed_4a'):
        with tf.variable_scope('Branch_0'):
          ...
          branch_0 = slim.conv2d(branch_0, 96, [3, 3], padding='VALID',
                                 scope='Conv2d_1a_3x3',normalizer_fn=slim.batch_norm)
        with tf.variable_scope('Branch_1'):
          branch_1 = slim.conv2d(net, 64, [1, 1], scope='Conv2d_0a_1x1',normalizer_fn=slim.batch_norm)
          branch_1 = slim.conv2d(branch_1, 64, [1, 7], scope='Conv2d_0b_1x7',normalizer_fn=slim.batch_norm)
          branch_1 = slim.conv2d(branch_1, 64, [7, 1], scope='Conv2d_0c_7x1',normalizer_fn=slim.batch_norm)
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
        ...
        if create_aux_logits:
          with tf.variable_scope('AuxLogits'):
            ...
            aux_logits = slim.conv2d(aux_logits, 768,
                                     ...
                                     padding='VALID', scope='Conv2d_2a',normalizer_fn=slim.batch_norm,weights_initializer=trunc_normal(0.1))
        ...
        with tf.variable_scope('Logits'):
          ...
          # 1536
          logits = slim.fully_connected(net, num_classes, activation_fn=None,weights_initializer=trunc_normal(0.1),
                                        scope='Logits')
...
class my_nets:
    ...
    def build_net_and_get_logits(self):
        ...
        self.logits, self.end_points = inception_v4(inputs=self.inputs,num_classes=3)
